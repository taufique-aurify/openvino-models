...
In other cases, you should consider using POT [API](compression/api/README.md). To start with POT CLI please refer to the
following [example](../docs/E2eExample.md).

Note: There is also the so-called [**Simplified mode**](../configs/README.md) that is basically aimed at INT8 quantization if the model is from the Computer Vision
...
## Prerequisites
1. Install POT following the [Installation Guide](docs/InstallationGuide.md).
...
methods available. See [POT configuration file description](configs/README.md) for more details. 
...
See also the [How to Run Examples tutorial](configs/examples/README.md) about how to run a particular example of 8-bit
