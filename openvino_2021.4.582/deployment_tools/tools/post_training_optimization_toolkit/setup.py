...
setup(
    name='pot',
    version=find_version(os.path.join(here, 'compression/version.py')),
    author='Intel',
    ...
    package_data={"compression.configs.hardware": ['*.json'],
                  "compression.api.samples": ['*.md', '*/*.md'],
                  "configs": ["default_quantization_template.json",
